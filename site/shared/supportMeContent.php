        <div class="main home">
            ...
            <div class="subMain sectGeneral">
              <div class='intro'>
                <a href="about"><img class="mugshot" src="<?php echo htmlspecialchars($assetPathPrefix ?? '', ENT_QUOTES, 'UTF-8'); ?>images/BSMMugshot_Trimmed_280x280.jpg" alt="mugshot of Carl"/></a>
