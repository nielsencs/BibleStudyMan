...
<?php if (!empty($controlPanelScriptSrc)) { ?>
<script type="text/javascript" src="<?php echo htmlspecialchars($controlPanelScriptSrc, ENT_QUOTES, 'UTF-8'); ?>"></script>
<?php } ?>
<script type="text/javascript">
// ============================================================================
  function doSubmit(tField) { // this Javascript function MUST remain here because PHP below decides whether an empty submit should run
// ============================================================================
    bDoit = false;
    if(tField > ''){
//      bDoit = (tField === 'chapter')||(document.getElementById(tField).value);
    ...
    if(bDoit){
<?php if (!empty($submitBiblePriority)) { ?>
      if (document.searchForm.priority) {
